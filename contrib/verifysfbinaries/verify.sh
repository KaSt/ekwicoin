...
###   This script attempts to download the signature file SHA256SUMS.asc from ekwicoin.org
...
WORKINGDIR="/tmp/ekwicoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://ekwicoin.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://ekwicoin.org/bin/"
VERSIONPREFIX="ekwicoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'ekwicoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[ekwicoin-]<version>-[rc[0-9]] (example: ekwicoin-0.9.2-rc1)"
   echo "wget output:"
