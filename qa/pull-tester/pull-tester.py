...
Contact BlueMatt on freenode if something looks broken."""
    ...
    # Remove old EkwicoinPullTester comments (I'm being lazy and not paginating here)
...
def testpull(number, comment_url, clone_url, commit):
    ...
    script += " ${BUILD_PATH} ${MINGW_DEPS_DIR} ${SCRIPTS_DIR}/EkwicoindComparisonTool_jar/EkwicoindComparisonTool.jar 0 6 ${OUT_DIR}"
...
environ_default("CLONE_URL", "https://github.com/ekwicoin/ekwicoin.git")
...
environ_default("BUILD_PATH", "/mnt/ekwicoin")
...
environ_default("GITHUB_REPO", "ekwicoin/ekwicoin")
