Ekwicoin Core version 0.9.1 is now available from:

  https://ekwicoin.org/bin/0.9.1/
...
ekwicoind from any pre-0.9.1 version, and have enabled SSL for RPC and
...
installer (on Windows) or just copy over /Applications/Ekwicoin-Qt (on Mac) or
ekwicoind/ekwicoin-qt (on Linux).
...
- Upgrade OpenSSL to 1.0.1g. This release fixes the following vulnerabilities which can
  affect the Ekwicoin Core software:
