Ekwicoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/ekwicoin/files/Ekwicoin/ekwicoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Ekwicoin
...
New/changed settings (command-line or ekwicoin.conf file)
--------------------------------------------------------
