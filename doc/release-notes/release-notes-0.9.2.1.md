Ekwicoin Core version 0.9.2.1 is now available from:

  https://ekwicoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 EKW to 0.01 EKW
...
- Fix "Start ekwicoin on system login"
