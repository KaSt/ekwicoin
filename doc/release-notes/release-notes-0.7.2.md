Ekwicoin version 0.7.2 is now available from:
  http://sourceforge.net/projects/ekwicoin/files/Ekwicoin/ekwicoin-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused Ekwicoin-Qt to crash on Windows when exiting.
