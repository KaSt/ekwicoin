...
/** Ekwicoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class EkwicoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit EkwicoinUnits(QObject *parent);

    /** Ekwicoin units.
      @note Source: https://en.ekwicoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        EKW,
...
typedef EkwicoinUnits::Unit EkwicoinUnit;
