...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/ekwicoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Ekwicoin"),
     ...
     * override -datadir in the ekwicoin.conf file in the default data directory
     * (to be consistent with ekwicoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
