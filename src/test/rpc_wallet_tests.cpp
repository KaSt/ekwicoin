...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
	...
	CEkwicoinAddress demoAddress = CEkwicoinAddress(CTxDestination(demoPubkey.GetID()));
	Value retValue;
	...
	BOOST_CHECK(CEkwicoinAddress(retValue.get_str()).Get() == demoAddress.Get());
	...
	BOOST_CHECK(CEkwicoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
