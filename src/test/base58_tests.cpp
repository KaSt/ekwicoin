// Copyright (c) 2011-2014 The Ekwicoin Core developers
...
BOOST_AUTO_TEST_CASE(base58_keys_valid_parse)
{
    ...
    BOOST_FOREACH(Value& tv, tests)
    {
        ...
        if(isPrivkey)
        {
            ...
            // Note: CEkwicoinSecret::SetString tests isValid, whereas CEkwicoinAddress does not!
